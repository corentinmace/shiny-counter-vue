...
<div class="h-screen flex justify-center items-center">
  <div class="w-1/2 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mt-10">
          <div class="mb-6">
          ...
          <div class="mb-6">
              ...
              <input v-model="nickname" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required id="nickname" type="text">
              <!-- <p class="text-red-500 text-xs italic">Please choose a password.</p> -->
          </div>
